...
(function () {
  ...
  const translations = {
    en: {
      ...
      loginSub: "FLEET ERP & BILLING PORTAL"
    },
    gu: {
      ...
      craneTitle: "ક્રેન",
      customerTitle: "ગ્રાહકો",
      invoiceTitle: "ઇન્વોઇસ",
      operatorTitle: "ઓપરેટર",
      paymentTitle: "પેમેન્ટ",
      documentTitle: "દસ્તાવેજ",
      settingsTitle: "સેટિંગ્સ",
      logout: "લૉગ આઉટ",
      loginTitle: "એપેક્સ ક્રેન સર્વિસીસ",
      loginSub: "ફ્લીટ ERP અને બિલિંગ પોર્ટલ"
    },
    hi: {
      navDashboard: "डैशबोर्ड",
      navCranes: "क्रेन",
      navCustomers: "ग्राहक",
      navInvoices: "चालान (बिल)",
      navOperators: "ऑपरेटर",
      navPayments: "भुगतान",
      ...
      invoiceTitle: "चालान (बिल)",
      operatorTitle: "ऑपरेटर",
      paymentTitle: "भुगतान",
      documentTitle: "दस्तावेज़",
      settingsTitle: "सेटिंग्स",
      logout: "लॉग आउट",
      loginTitle: "एपेक्स क्रेन सर्विसेज",
      loginSub: "बेड़ा ERP एवं बिलिंग पोर्टल"
    },
    te: {
      ...
      navOperators: "ఆపరేటర్లు",
      navPayments: "చెల్లింపులు",
      navDocuments: "డాక్యుమెంట్లు",
      ...
      craneTitle: "క్రేన్లు",
      customerTitle: "కస్టమర్లు",
      invoiceTitle: "ఇన్‌వాయిస్‌లు",
      operatorTitle: "ఆపరేటర్లు",
      paymentTitle: "చెల్లింపులు",
      documentTitle: "డాక్యుమెంట్లు",
      settingsTitle: "సెట్టింగ్‌లు",
      logout: "లాగ్ అవుట్",
      loginTitle: "అపెక్స్ క్రేన్ సర్వీసెస్",
      loginSub: "ఫ్లీట్ ERP & బిల్లింగ్ పోర్టల్"
    },
    mr: {
      navDashboard: "डॅशबोर्ड",
      navCranes: "क्रेन",
      navCustomers: "ग्राहक",
      navInvoices: "बिले (इनव्हॉईस)",
      navOperators: "ऑपरेटर",
      navPayments: "पेमेंट",
      ...
      craneTitle: "क्रेन",
      customerTitle: "ग्राहक",
      invoiceTitle: "बिले (इनव्हॉईस)",
      operatorTitle: "ऑपरेटर",
      paymentTitle: "पेमेंट",
      documentTitle: "कागदपत्रे",
      settingsTitle: "सेटिंग्ज",
      logout: "लॉग आउट",
      loginTitle: "अ‍ॅपेक्स क्रेन सर्व्हिसेस",
      loginSub: "ताफा ERP आणि बिलिंग पोर्टल"
    }
  };
